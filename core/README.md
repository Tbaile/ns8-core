...
*   [ubind-user-domains-input](./ubind-user-domains-input.md "Input schema of the ubind-user-domains action") – `http://schema.nethserver.org/cluster/ubind-user-domains-input.json`
...
*   [Untitled array in ubind-user-domains-input](./ubind-user-domains-input-properties-domains.md "One or more domains to ubind from the module calling this action") – `http://schema.nethserver.org/cluster/ubind-user-domains-input.json#/properties/domains`
